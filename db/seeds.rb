...
Book.create!([{
  ...
  stock: 20,
  category_id: 10,
  author: Author.create!(firstname: "J. R. R.", lastname: "Tolkien")
},
{
  title: "The Martian",
  ...
  stock: 11.25,
  category_id: 11,
  author: Author.create!(firstname: "Andy", lastname: "Weir")
},
{
  title: "Unbroken",
  ...
  stock: 17,
  category_id: 2,
  author: Author.create!(firstname: "Laura", lastname: "Hillenbrand")
}])
